...
class RepresentationFlowView {
  public:
    RepresentationFlowView(std::shared_ptr<QTableView> view, const std::shared_ptr<QWidget> &mainWindow, int flowWidth);
    void setVisibility(bool ascii, bool dec, bool hex, bool bin);
    void add(const std::string &ascii, const std::string &dec, const std::string &hex, const std::string &bin,
